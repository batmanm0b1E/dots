...
drive_paths = {"/home", "/run/media/dobbie/Music/", "/run/media/dobbie/Movies/"}

-- Names of drives for free space status.
drive_names = {"Home", "Music", "Movies"}
...
function draw_function(cr)
	...
	cairo_select_font_face (cr, "Product Sans", CAIRO_FONT_SLANT_NORMAL, CAIRO_FOlNT_WEIGHT_NORMAL);
