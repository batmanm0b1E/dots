...
local imgFace =  imlib_load_image(image_path..theme..'/.config/conky/face.png')
local w_img, h_img = fGetImageSize(imgFace)

local imgH =  imlib_load_image(image_path..theme..'/.config/conky/h.png')
local imgHR = fRotateImage (imgH, arc_h)
local w_imgH, h_imgH = fGetImageSize(imgHR)

local imgM =  imlib_load_image(image_path..theme..'/.config/conky/m.png')
local imgMR = fRotateImage (imgM, arc_m)
local w_imgM, h_imgM = fGetImageSize(imgMR)

local imgS =  imlib_load_image(image_path..theme..'/.config/conky/s.png')
local imgSR = fRotateImage (imgS, arc_s)
local w_imgS, h_imgS = fGetImageSize(imgSR)

local imgGlass =  imlib_load_image(image_path..theme..'/.config/conky/glass.png')
