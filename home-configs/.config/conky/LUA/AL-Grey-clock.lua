...
Tweaked for: Dobbie03 - 2017-06-26
...
local mhr,mhg,mhb,mha=0.5,0.5,0.5,1  --fully opaque mid grey
...
--set hour hand color
local hhr,hhg,hhb,hha=0.4,0.4,0.4,1  --darker grey than Minute hand
--##############################################################################
--   END SETTINGS AREA
--##############################################################################
